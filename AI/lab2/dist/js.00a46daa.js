...
(0, _jquery.default)(function () {
  //const inputsFormOne = document.querySelectorAll('input[name="form-one"]');
  // const inputsFormOneUnclear = document.querySelectorAll('input[name="form-one-unclear"]');
  // const inputsFormOneFirstTime = document.querySelectorAll('input[name="form-one-first-time"]');
  // const inputsFormOneStorm = document.querySelectorAll('input[name="form-one-storm"]');
  var btnNext = document.getElementById('next');
  var curForm = document.querySelector('form.active');
  btnNext.addEventListener('click', function () {
    var curArrayName = 'inputs' + curForm.id.replace('-', ' ').capitalize(true).replace(' ', '');
    console.log(curForm.id.replace('-', ' ').capitalize(true).replace(' ', ''));
    console.log(curArrayName);
    var curArray = makeList("curArrayName");
    Array.prototype.forEach.call(document.querySelectorAll('input[name=' + curForm.id + ']'), function (element) {
      curArray.push(element);
    });
    console.log(curArray);
    var result = curArray.filter(function (input) {
  ...
  String.prototype.capitalize = function (allWords) {
    ...
    }).join(' ') : this.charAt(0).toUpperCase() + this.slice(1);
  };
});
},{"normalize.css":"node_modules/normalize.css/normalize.css","./../css/main.scss":"css/main.scss","jquery":"node_modules/jquery/dist/jquery.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
